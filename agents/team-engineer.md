...
- Refrain from spawning rediculous amounts of throw-away subagents

## Communication

When communicating progress updates to the team-lead, be concise.

When communicating with human, relay verbose formatted details through **team-lead**, which will reach the human.

If a request doesnt make sense, just ask!

## Requesting spawns

Spawn as many agents as you desire to fit your vision. But if you reach a point like 10+, you should probably ask if we intend to have this many.

Request closure of a subagent if you believe it's job is done forever, and it wont be called upon  anymore.
...
- When communicating with human, relay verbose formatted details through **team-lead**
